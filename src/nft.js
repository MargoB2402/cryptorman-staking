...
export default function NFT() {
  ...
  async function callApi() {
    ...
    vaultcontract = new web3.eth.Contract(VAULTABI, STAKINGCONTRACT);
		...
		const nfts = await axios.get((moralisapi + `/${account}/nft/${NFTCONTRACT}/?chain=polygon&format=decimal`), {headers: config})
    .then(output => {
    ...
    return (
          <h1 className="text-3xl">Wallet Not Connected or You don't have CryptorMan</h1>)
    return (
                      ...
                      <div className="card nft-card mt-3 mb-3" key={i} >
                        ...
                        <div className="card-caption col-12 p-0">
                          <div className="card-body">
                            <h5 className="mb-0">CryptorMan Collection NFT #{nft.tokenId}</h5>
                    ...
                    {nftstk.map((nft, i) => {
                      ...
                      return (
                        ...
                        <div className="card stakedcard mt-3 mb-3" key={i} >
                          <div className="image-over">
                          <img style={{position:'absolute',top:'0.05rem',width:'90px'}} src='pig-coin.png'></img>
                            <img className="card-img-top" src={nftpng + nft.tokenId + '.png'} alt="" />
                          </div>
                          <div className="card-caption col-12 p-0">
                            <div className="card-body">
