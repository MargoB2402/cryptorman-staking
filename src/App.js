...
const Web3Alc = createAlchemyWeb3("https://polygon-mainnet.g.alchemy.com/v2/ygldvOAAtBT4O-ovJ5F9WJhJbfyWK04I");

const moralisapikey = "m9gSjVOz3i5rrwZ1eAXI09CFxusbEZubVa5abdGcJ7Y2sw9aPW9RelWeK18e8wnG";
const polygonscanapikey = "MRDY2M732YH7VNUSWZC1FMSGH77SFXRF18";
    ...
    <div className="App nftapp">
        <nav class="navbar navbarfont navbarglow navbar-expand-md navbar-dark bg-dark mb-4">
          <div class="container-fluid" style={{ fontFamily: "SF Pro Display" }}>
            <a class="navbar-brand px-5" style={{ fontWeight: "800", fontSize: '25px' }} href="#"></a><img src="cryptorverse-logo.png" width="7%" />
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="navbar-nav me-auto mb-2 px-3 mb-md-0" style={{ fontSize: "25px" }}>
                ...
                <li class="nav-item">
                  <a class="nav-link" target="blank" href="https://opensea.io/collection/cryptorman">Buy CryptorMan</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" target="blank" href="https://cryptor.store/pages/cryptorman-beginning">About CryptorMan</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" target="blank" href="https://cryptor.store/pages/faq-staking">FAQ Staking</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" target="blank" href="https://cryptor.store/pages/whitepaper">WhitePaper</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className='container container-style'>
          ...
          <form>
            <div className="row pt-3">
              <div>
                <h3 className="pt-2" style={{ fontWeight: "30" }}>CRYPTOR address:</h3>
              </div>
              <h6>0x65a7e0b4277C16bcfC75b5e87cB2c7A09ae5Cc79</h6>
              </div>
              <img className="col-lg-12" src="banner1000-1500.gif"/>
        ...
        <div className='col'>
          <body className='nftstaker border-0'>
            <form  style={{ fontFamily: "SF Pro Display" }} >
              <h2 style={{ borderRadius: '14px', fontWeight: "300", fontSize: "25px" }}>CryptorMan NFT Staking </h2>
              ...
              <div className="row px-3">
                <div className="col">
                  ...
                  <div className="col">
                    <form className='stakingrewards' style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff", fontFamily: "SF Pro Display" }}>
                      ...
                      <Button onClick={rewardinfo} style={{ backgroundColor: "#ffffff10", boxShadow: "1px 1px 5px #000000" }} >Earned CRYPTOR Rewards</Button>
                ...
                <div className="row px-4 pt-2">
                  <div class="header">
                    <div style={{ fontSize: '25px', borderRadius: '14px', color: "#ffffff", fontWeight: "300" }}>CryptorVerse NFT Staking Pool Active Rewards</div>
                    <table className='table px-3 table-bordered table-dark'>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Utility Collection</td>
                          <td class="amount" data-test-id="rewards-summary-ac">
                            <span class="amount">1</span>&nbsp;<span class="currency">CRYPTOR</span>
                          </td>
                        </tr>

                        <tr>
                          <td>Ultimate 10000 Collection - coming soon</td>
                          <td class="amount" data-test-id="rewards-summary-ads">
                            <span class="amount">5</span>&nbsp;<span class="currency">CRYPTOR</span>
                          </td>
                        </tr>

                        <tr className='stakegoldeffect'>
                          <td>CryptorMan Collection</td>
                          <td class="amount" data-test-id="rewards-summary-one-time"><span class="amount">10</span>&nbsp;<span class="currency">CRYPTOR</span>
                          </td>
                        </tr>
                    ...
                    <div class="header">
                      <div style={{ fontSize: '25px', borderRadius: '14px', fontWeight: '300' }}>CRYPTOR Token Stake Farms</div>
                      <table className='table table-bordered table-dark' style={{ borderRadius: '14px' }} >
                        <thead className='thead-light'>
                          <tr>
                            <th scope="col">Farm Pools - coming soon</th>
                            <th scope="col">Harvest Daily Earnings</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td>Stake CRYPTOR to Earn CRYPTOR</td>
                            <td class="amount" data-test-id="rewards-summary-ads">
                              <span class="amount">0.01</span>&nbsp;<span class="currency">Per CRYPTOR</span>
                            </td>
                          </tr>
                        </tbody>
                      </table>
      ...
      <div className='row nftportal mt-3'>
        ...
        <img src="cryptorverse-logo.png" width={'30%'}></img>
      </div>
      <div className='col'>
        <h1 className='n2dtitlestyle mt-3'>Your NFT</h1>
      <Button onClick={refreshPage} style={{ backgroundColor: "#000000", boxShadow: "1px 1px 5px #000000" }}>Refresh NFT</Button>
      </div>
